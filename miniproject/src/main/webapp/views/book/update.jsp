...
<div class="form-group">
    ...
    <label >Stock</label>
    <form:input type="text" id="stock" name="stock" path="stock"/>

</div>
<div class="form-group">

    <label >Total Pages</label>
    <form:input type="text" id="totalPages" name="totalPages" path="totalPages"/>

</div>
<div class="form-group">

    <label >Year Created</label>
    <form:input type="text" id="yearCreated" name="yearCreated" path="yearCreated"/>

</div>
<div class="form-group">

    <label >Author</label>
    <form:input type="text" id="author" name="author" path="author"/>
